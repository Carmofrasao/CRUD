def converter(dicionario, tipo, entrada, acao):
    ...
    elif type(eval(entrada)) is float:
        if acao == 1:
    ...
    elif type(eval(entrada)) is complex:
        if acao == 1:
    ...
    elif type(eval(entrada)) is list:
        if acao == 1:
    ...
    elif type(eval(entrada)) is tuple:
        if acao == 1:
    ...
    elif type(eval(entrada)) is range:
        if acao == 1:
    ...
    elif type(eval(entrada)) is bytes:
        if acao == 1:
    ...
    elif type(eval(entrada)) is bytearray:
        if acao == 1:
    ...
    elif type(eval(entrada)) is memoryview:
        if acao == 1:
    ...
    elif type(eval(entrada)) is frozenset:
        if acao == 1:
    ...
    elif type(eval(entrada)) is dict:
        if acao == 1:
